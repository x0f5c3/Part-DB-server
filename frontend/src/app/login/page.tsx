 ...
 *
 * Authentication is handled entirely by Supabase Auth.  After a successful
...
export default function LoginPage() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-gradient-to-b from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 p-4">
      <div className="w-full max-w-md space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Use your preferred method to access your inventory.
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-4">
            ...
            {mode === "magic-link" && magicLinkSent && (
              <div className="rounded-md bg-green-50 dark:bg-green-900/20 px-4 py-3 text-sm text-green-700 dark:text-green-300">
                ✉️ Check your inbox — a sign-in link has been sent to{" "}
                <strong>{email}</strong>.
              </div>
            )}
          </CardContent>
        ...
        <p className="text-center text-xs text-muted-foreground">
          Part-DB — Open Source Electronic Parts Management
        </p>
      </div>
    </main>
  );
